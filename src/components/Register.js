...
const Register = () => {
  ...
  const handleGoogleLogin = () => {
    ...
    // Redirect to the backend Google login route
    const googleLoginUrl = `${BASE_URL}/api/user/auth/google${referralCodeFromUrl  ? `?referralCode=${referralCodeFromUrl}` : ''}`;
      ...
      <div className="flex flex-col md:flex-row w-full max-w-4xl rounded-lg shadow-lg bg-gray-500">
        ...
        <div className="w-full md:w-1/2 p-6">
          ...
          <h1 className="text-3xl font-bold mb-4 text-black text-center">
            "Discover, Listen, Enjoy—Join Us Today!"
          </h1>
          <Formik
            initialValues={{
              firstName: "",
        ...
        <div className="w-full md:w-1/2 p-6 flex flex-col justify-center items-center bg-gray-200 rounded-lg">
          ...
          <p className="text-black text-center mb-6">
            Your journey to discovering amazing music begins here. Create an
