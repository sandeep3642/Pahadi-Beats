...
const TermsCondition = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-purple-1000 px-4 py-8">
      <div className="bg-white rounded-lg shadow-lg p-6 md:p-12 w-full max-w-3xl">
        <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4 text-center">
          Terms & Conditions
        </h1>
        <p className="text-gray-600 mb-4 text-center">
          Last updated on 03-09-2024 08:47:09
        </p>
        <div className="text-gray-700 text-justify space-y-4">
          <p>
            ...
            Sandeep Ghildiyal, (“Website Owner” or “we” or “us” or “our”) and
          ...
          <p>
            ...
            Policy). We reserve the right to modify these Terms at any time and
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>
              You understand that upon initiating a transaction for availing of
